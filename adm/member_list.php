...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" colspan="7" id="mb_list_cert"><?php echo subject_sort_link('mb_certify', '', 'desc') ?>본인확인</a></th>
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_womanc"><?php echo subject_sort_link('mb_woman', '', 'desc') ?>여성<br>인증</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_cert" colspan="7" class="td_mbcert">
