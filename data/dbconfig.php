...
define('G5_MYSQL_USER', 'lebolution');
define('G5_MYSQL_PASSWORD', 'oldi1991cv');
define('G5_MYSQL_DB', 'lebolution');
...
$g5['login_data_table'] = G5_TABLE_PREFIX.'login_data'; // 로그인 성공/실패 기록 테이블
