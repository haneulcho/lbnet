...
<div class="lb_userad">
	...
	<div id="userad" class="txtonly owl-carousel">
...
.lb_userad {min-height:114px;max-height:224px;margin-bottom:15px;background-color:#fff;box-shadow:0 5px 19px rgb(232, 232, 232)}
...
#userad {position:relative;overflow:hidden;width:100%;margin:0;padding:0}
