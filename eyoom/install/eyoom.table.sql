...
CREATE TABLE IF NOT EXISTS `g5_eyoom_board` (
  ...
  `bo_use_anonymous_respond` char(1) NOT NULL default '2',
  `bo_use_timer` char(1) NOT NULL default '0',
  ...
  `bo_timer_start` datetime NOT NULL default '0000-00-00 00:00:00',
  `bo_timer_end` datetime NOT NULL default '0000-00-00 00:00:00',
